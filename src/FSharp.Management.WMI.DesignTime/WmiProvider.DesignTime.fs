...
type internal RuntimeInfo (config : TypeProviderConfig) =
    ...
    let RuntimeAPI = runtimeAssembly.GetType("FSharp.Management.Runtime.RuntimeAPI")
    ...
    member val InstanceOperationClass = runtimeAssembly.GetType("FSharp.Management.Runtime.InstanceOperation`1")
    member val InstanceModificationClass = runtimeAssembly.GetType("FSharp.Management.Runtime.InstanceModification`1")
    member val DataContextClass = runtimeAssembly.GetType("FSharp.Management.Runtime.DataContext")
    member val MethodInvocationClass = runtimeAssembly.GetType("FSharp.Management.Runtime.MethodInvocation`1")
    member val WmiEventClass = runtimeAssembly.GetType("FSharp.Management.Runtime.WmiEvent`2")
